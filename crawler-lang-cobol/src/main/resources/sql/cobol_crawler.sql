...
ALTER TABLE CRAWLER.VI_COBOL_FILE ADD CONSTRAINT VI_COBOL_FILE_FK1 FOREIGN KEY (TRIGGER_ID)  REFERENCES CRAWLER.VI_CRAWLER_TRIGGER(ID);
...
ALTER TABLE CRAWLER.VI_COBOL_FILE_CODE_METRICS ADD CONSTRAINT VI_COBOL_FILE_CODE_METRICS_FK1 FOREIGN KEY (TRIGGER_ID)  REFERENCES CRAWLER.VI_CRAWLER_TRIGGER(ID);
...
ALTER TABLE CRAWLER.VI_COBOL_FILE_REFERENCE ADD CONSTRAINT VI_COBOL_FILE_REFERENCE_FK1 FOREIGN KEY (TRIGGER_ID)  REFERENCES CRAWLER.VI_CRAWLER_TRIGGER(ID);
